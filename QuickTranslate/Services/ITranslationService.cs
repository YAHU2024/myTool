...
namespace QuickTranslate.Services
{
    ...
    public interface ITranslationService
    {
        ...
        Task<string> TranslateStreamingAsync(string text, string targetLang, Action<string> onChunk, ContentType contentType = ContentType.Translation, Action? onFallbackUsed = null);
        ...
        /// 流式解析文本（用目标语言深度解析）
        /// </summary>
        Task<string> AnalyzeStreamingAsync(string text, string targetLang, Action<string> onChunk);
    }
}
