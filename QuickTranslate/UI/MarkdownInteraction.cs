...
{
    public static void ConfigureSelectableHost(RichTextBox markdown, string automationName)
    {
        ...
        markdown.VerticalScrollBarVisibility = ScrollBarVisibility.Disabled;
