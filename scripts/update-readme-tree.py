...
ZH_QUICK = _mk(
    ...
    ("Services/IScreenshotBatchTranslationService.cs", "截图结构化批量翻译接口"),
    ("Services/IScreenshotBatchStreamingTranslationService.cs", "截图单元完成级流式翻译接口"),
    ("Services/ScreenshotTranslationStreamParser.cs", "截图结构化流式响应解析与 ID 校验"),
    ("Services/ScreenshotTranslationFailure.cs", "截图翻译失败分类与超时契约"),
    ...
    ("Services/RapidOcrWorkerService.cs", "隔离 RapidOCR/ONNX Worker 服务"),
    ("Services/ScreenshotOcrServiceFactory.cs", "截图 OCR 引擎选择与回退"),
    ...
    ("Models/ScreenshotOverlayModels.cs", "截图译文覆盖层模型"),
    # Helpers
    ("Helpers/", "工具类"),
    ...
    ("UI/ScreenshotTranslationOverlayWindow.xaml/.cs", "截图译文覆盖窗口"),
    ("UI/ScreenshotTranslationProgressWindow.xaml/.cs", "截图 OCR 翻译进度与取消窗口"),
...
EN_QUICK = _mk(
    ...
    ("Services/IScreenshotBatchTranslationService.cs", "Screenshot structured batch translation interface"),
    ("Services/IScreenshotBatchStreamingTranslationService.cs", "Screenshot unit-completion streaming interface"),
    ("Services/ScreenshotTranslationStreamParser.cs", "Screenshot structured stream parser and ID validation"),
    ("Services/ScreenshotTranslationFailure.cs", "Screenshot failure classification and timeout contract"),
    ...
    ("Services/RapidOcrWorkerService.cs", "Isolated RapidOCR/ONNX worker service"),
    ("Services/ScreenshotOcrServiceFactory.cs", "Screenshot OCR engine selection and fallback"),
    ...
    ("Models/ScreenshotOverlayModels.cs", "Screenshot translation overlay models"),
    ("Helpers/", "Utilities"),
    ...
    ("UI/ScreenshotTranslationOverlayWindow.xaml/.cs", "Screenshot translation overlay window"),
    ("UI/ScreenshotTranslationProgressWindow.xaml/.cs", "Screenshot OCR progress and cancel window"),
